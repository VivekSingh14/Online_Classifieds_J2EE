...
%>
		...
		<a href="category.jsp?mode=add&user_id=<%=user_id%>">Add New category</a><br>
...
<%
...
else if("edit".equals(mode))
	{
		...
		%>
		<form action="categoryedit.jsp?cat_id=<%=cat_id%>" method="post" enctype="multipart/form-data">
		<div class="panel-group" id="accordion" style="margin-top:70px;">
<div class="panel panel-info">
<div class="panel-heading">
<h3 class="panel-heading">
...
<div class="panel-body">
		...
		<tr>
		<td>Category Name</td>
		<td><input id="editname" type="text" name="cat_name"  value="<%=cat_name%>"/></td>
		</tr>
		<tr><td><img src="/./olx/categoryimages/<%=cat_pic%>" alt="category_img" style="width:40px;height:40px" /></td>
		    <td><input type="file" name="uploadpic" size="200000" /></td></tr>
	...
	else if("add".equals(mode))
	{
		int r=s1.maxId()+1;
%>
	<form action="categorysave.jsp?cat_id=<%=r %>" method="post" name="addform" enctype="multipart/form-data">
	<div class="panel-group" id="accordion" style="margin-top:70px;">
<div class="panel panel-info">
<div class="panel-heading">
<h3 class="panel-heading">
