...
%>
		...
		<a href="subcategory.jsp?mode=add&user_id=<%=user_id%>">Add New Sub category</a><br>
...
%>
		<form action="subcategoryedit.jsp?subcat_id=<%=subcat_id%>" method="post" enctype="multipart/form-data">
		<div class="panel-group" id="accordion" style="margin-top:70px;">
<div class="panel panel-info">
<div class="panel-heading">
<h3 class="panel-heading">
...
<div class="panel-body">
		...
		<td><input type="text" name="subcat_name"  value="<%=subcat_name%>"/></td>
		</tr>
	...
	else if("add".equals(mode))
	{
		int r=s1.maxId()+1;
			Vector<String []> v = s1.showcatid();
%>
	<form action="subcategorysave.jsp?subcat_id=<%=r %>&user_id=<%=user_id%>" method="post" name="addform" enctype="multipart/form-data">
	<div class="panel-group" id="accordion" style="margin-top:70px;">
<div class="panel panel-info">
<div class="panel-heading">
<h3 class="panel-heading">
