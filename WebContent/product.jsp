...
&nbsp;&nbsp; |  &nbsp;&nbsp;
<a href="dashboard.jsp?user_id=<%=id%>">Go Back To Dashboard </a>
<%
		}
%>
<%		
...
<div class="panel-heading">
<h3 class="panel-heading">
<a href="#collpaseone" data-toggle="collapse" data-parent="accordion">Update Product Details </a> </h3>
</div>
<div id="collpaseone" class="panel-collapse collapse in">
<div class="panel-body">
...
%>
	<h1>deleted</h1>
	<a href="product.jsp?mode=showall&user_id=<%=id %>">Go Back</a>
...
%>
	...
	<form action="submitnewad.jsp?user_id=<%=user_id %>" method="post" id="usrform" enctype="multipart/form-data">
	<br>
<div class="panel-group" id="accordion">
<div class="panel panel-default">
<div class="panel-heading">
<h3 class="panel-heading">
<a href="#collpaseone" data-toggle="collapse" data-parent="accordion">Add Product </a> </h3>
</div>
<div id="collpaseone" class="panel-collapse collapse in">
<div class="panel-body">
...
%>
			...
			<tr>
				<th>Upload Photo</th>
				<td><input type="file" name="uploadpic" size="200000" /></td>
			</tr>
			<tr>
				<th>Price</th>
			...
			<tr>
				<th>Description</th>
				<td><textarea name="description" form="usrform" placeholder="Enter your description"></textarea></td>
			</tr>
			<tr>
				<th>Post Date</th>
				<td><input type="date" name="postdate" value="yyyy-mm-dd" /></td>
			</tr>
